 ...
 *  rb_tools.h: Header for the various tool functions.
 *
...
static inline void
rb_dlinkAddAlloc(void *data, rb_dlink_list *list)
{
	rb_dlinkAdd(data, rb_malloc(sizeof(rb_dlink_node)), list);
}

static inline void
rb_dlinkAddTailAlloc(void *data, rb_dlink_list *list)
{
	rb_dlinkAddTail(data, rb_malloc(sizeof(rb_dlink_node)), list);
}

static inline void
rb_dlinkDestroy(rb_dlink_node *node, rb_dlink_list *list)
{
	rb_dlinkDelete(node, list);
	rb_free(node);
}
