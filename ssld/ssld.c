 ...
 *  USA
 *
 *  $Id: ssld.c 29265 2015-12-20 04:35:39Z androsyn $
 */
...
check_handshake_flood(void *unused)
{
	...
	HASH_WALK_SAFE(i, CONN_HASH_SIZE, ptr, next, connid_hash_table)
	{
		...
		/* nothing needs to do this more than five times in ten seconds i don't think */
		if(count > 5)
...
main(int argc, char **argv)
{
	...
	if(s_ctlfd == NULL || s_pipe == NULL || s_pid == NULL)
	{
		...
		fprintf(stderr,
			"You get an Id tag for this: $Id: ssld.c 29265 2015-12-20 04:35:39Z androsyn $\n");
